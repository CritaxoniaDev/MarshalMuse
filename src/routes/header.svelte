<script>
	...
	import { Menu, X, Github, Search, Sun, Moon } from 'lucide-svelte';
	...
	let headerSpring = spring(
		{ y: 0 },
		{
			stiffness: 3.0, // Increased from 0.1
			damping: 1.5 // Increased from 0.15
		}
	);
		...
		{#if isMenuOpen}
			<div class="lg:hidden py-4">
				<div class="flex flex-col space-y-2">
					<a
						href="/features"
						class="px-4 py-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-colors"
						>Features</a
					>
					<a
						href="/docs"
