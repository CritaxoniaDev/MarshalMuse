...
>
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <!-- Desktop Navigation -->
            <div class="hidden lg:flex items-center justify-between flex-1 ml-10">
                <div class="flex items-center space-x-4">
                    <a
                        href="/features"
                        class="px-4 py-2 text-sm text-gray-600 rounded-lg hover:text-blue-600 transition-colors relative group"
                    >
                        Features
                        <span
                            class="absolute bottom-1.5 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 transition-transform origin-left group-hover:scale-x-100"
                        ></span>
                    </a>
                    <a
                        href="/docs"
        ...
        {#if isMenuOpen}
            <div class="lg:hidden py-4 transform transition-all duration-300 ease-in-out">
                <div class="flex flex-col space-y-3">
                    ...
                    <a
                        href="/features"
                        class="px-4 py-3 text-gray-600 hover:bg-blue-50 rounded-lg transition-all duration-200 relative group overflow-hidden"
                    >
                        <div class="relative z-10 flex items-center gap-2">
                            <span>Features</span>
                        </div>
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-blue-50 to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left"
                        ></div>
                    </a>
